...
- Reforma 2017 — estado y próximos pasos
- Clase media técnica — expansión y bienestar

**💰 ECONOMÍA Y FISCAL**
- Peso chileno, regla fiscal, excedentes del cobre/litio
- Exportaciones (cobre, litio, microelectrónica, software, servicios)
- Regalías e ingresos por propiedad intelectual
- Inversión pública vs. privada

**⚡ ENERGÍA**
- Solar norte, eólica sur, minihidro
- Smart grids, almacenamiento, hidrógeno verde
- Sostenibilidad y resiliencia de la matriz

**🏭 INDUSTRIA Y TECNOLOGÍA**
- Microelectrónica (PLCs, sensores, módulos de control)
- Manufactura avanzada (Atacama, Biobío, Talcahuano)
- Software logístico, automatización portuaria
- Patentes, PI, certificación soberana

**🚢 LOGÍSTICA Y COMERCIO**
- Corredor bioceánico (Mato Grosso → Agua Negra → Valparaíso)
- Puertos inteligentes (Valparaíso, Coquimbo, San Antonio)
- Rutas transpacíficas (impacto de tensiones en Taiwán)
- Trazabilidad, interoperabilidad aduanera

**🔬 CIENCIA Y TERRITORIO**
- Misiones científicas prioritarias
- Economía azul, cables submarinos, vigilancia costera
- Observación, datos, monitoreo territorial
- Antártica y glaciares

**🛡️ SEGURIDAD Y RESILIENCIA**
- Ciberresiliencia, redundancia analógica
- Infraestructura crítica blindada
- Soberanía digital

**🌍 DIPLOMACIA**
- India: contratos, regalías, implementación
- Japón / Corea: certificación, validación industrial
- Alemania: Industrie 4.0, hidrógeno, formación
...
- Ministerio de Transportes y Telecomunicaciones — trazabilidad, datos, conectividad
